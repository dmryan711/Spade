...
@interface SpadeMainSlideViewController () <SpadeEventDetailControllerDelegate,UIGestureRecognizerDelegate>

@property (strong, nonatomic) SpadeEventDetailViewController *centerViewController;
...
{    
    UIStoryboard *mainStoryboard = [UIStoryboard storyboardWithName:@"Main"
                                                             bundle: nil];
    //Create Center View
    self.centerViewController =[mainStoryboard   instantiateViewControllerWithIdentifier:@"eventDetailController"];
    self.centerViewController.object = self.object;
